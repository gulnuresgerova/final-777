...
const AddProduct = ({ setIsProductModal }) => {
    ...
    const handleCreate = async () => {
      ...
      data.append("upload_preset", "cars-shopping");
  ...
  return (
    <div className="fixed  top-0 left-0 w-screen h-screen pt-20 pb-20 z-50 after:content-[''] after:w-screen after:h-screen after:bg-white after:absolute after:top-0 after:left-0 after:opacity-60 grid place-content-center">
      <OutsideClickHandler onOutsideClick={() => setIsProductModal(false)}>
        <div className="w-full h-full  grid place-content-center relative">
          <div className="relative z-50 md:w-[600px]  w-[370px] back bg-white border-2 p-2 pr-10 pl-10 rounded-3xl">
            <Title addClass="text-[30px] text-center">Add a New Product</Title>
