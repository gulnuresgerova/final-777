...
const Index = ({ car }) => {
  ...
  return (
    <div>
      <Header />
      <div className="bg-black pb-44 min-h-[calc(100vh_-_433px)]  h-full">
        <div className="bg-[url('/images/red.png')] min-h-[calc(100vh_-_433px)] bg-no-repeat">
          <div className="flex  container pt-12 mt-24  items-center font-dancing md:h-[calc(100vh_-_88px)] gap-11 py-10 flex-wrap ">
            ...
            <div className="md:flex-1 flex flex-col align-center pt-14 justify-center text-white md:text-start text-center">
              <Title addClass="text-5xl">{car?.title}</Title>
              <span className="text-red text-2xl font-bold underline underline-offset-1 my-6 inline-block">
                ${price}
              </span>
              <p className="text-sm mb-7 md:pr-24">{car?.desc}</p>
              <div>
